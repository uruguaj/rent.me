            ...
            <Slider {...settings}>
                {sellers.map((brand)=>(
                    <div className=' text-black p-4'  key={brand.title}>
                        <img loading='lazy' className='rounded-t-lg aspect-[16/10]' src={brand.img} alt={brand.title}/>
                        <div className='p-3 bg-white rounded-b'>
                            <div className='text-center'>
                                <span className='block w-sans font-bold text-[1.3rem] mb-3'>{brand.title}</span>
                            </div>
